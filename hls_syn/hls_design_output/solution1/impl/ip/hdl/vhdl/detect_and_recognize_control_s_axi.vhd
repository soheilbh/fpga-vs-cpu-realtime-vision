...
entity detect_and_recognize_control_s_axi is
generic (
...
end entity detect_and_recognize_control_s_axi;
...
architecture behave of detect_and_recognize_control_s_axi is
    ...
    constant ADDR_RESULT_DATA_0 : INTEGER := 16#10#;
    constant ADDR_RESULT_CTRL   : INTEGER := 16#14#;
    ...
    signal int_result          : UNSIGNED(7 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_RESULT_DATA_0 =>
                        rdata_data <= RESIZE(int_result(7 downto 0), 32);
