...
entity detect_and_recognize_flood_fill_visited_RAM_2P_LUTRAM_1R1W is 
    generic(
        MEM_TYPE        : string    := "distributed"; 
        DataWidth       : integer   := 1; 
        AddressWidth    : integer   := 13;
        AddressRange    : integer   := 7500
    ); 
    port (
...
architecture rtl of detect_and_recognize_flood_fill_visited_RAM_2P_LUTRAM_1R1W is 
