...
# 2 "<built-in>" 2
# 1 "src/hls_wrapper.cpp" 2
# 1 "src/hls_detector.hpp" 1
...
# 6 "src/hls_detector.hpp" 2
# 17 "src/hls_detector.hpp"
struct BlobOutput {
    int prefix_sum;
    int min_x;
    int min_y;
...
# 2 "src/hls_wrapper.cpp" 2
# 1 "src/hls_recognizer.hpp" 1



# 1 "/tools/Xilinx/Vitis/2024.2/common/technology/autopilot/ap_int.h" 1
# 5 "src/hls_recognizer.hpp" 2
...
__attribute__((sdx_kernel("detect_and_recognize", 0))) void detect_and_recognize(
    ap_uint<8> frame[600][800],
    char& result
) {
#line 27 "/home/soheil/Desktop/mac_shared/fpga-vs-cpu-realtime-vision/hls_syn/hls.tcl"
#pragma HLSDIRECTIVE TOP name=detect_and_recognize
# 33 "src/hls_wrapper.cpp"
